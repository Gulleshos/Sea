...
export function CreateDoctorForm({ handleSubmit }) {
    return (
        <Form handleSubmit={handleSubmit} formId="doctorForm">
            ...
            <FormInput required={true} type="text" name="post" placeholder="Post" />
            <FormInput required={true} type="number" name="experience" placeholder="Experience" />
            <FormInput required={true} type="number" name="salary" placeholder="Salary" />
            <FormSelect required={true} name="accessLevel" defaultValue="Access level">
                <option value="doctor">Doctor</option>
                <option value="chief">Chief</option>
                <option value="admin">Admin</option>
            </FormSelect>
            <FormInput required={true} type="text" name="login" placeholder="Login" />
            <FormInput required={true} type="text" name="password" placeholder="Password" />
